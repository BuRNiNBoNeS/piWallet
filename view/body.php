...
{?>
    ...
    {  ?>
        ...
        foreach($transactionList as $transaction) {
            ...
            <?php }
    if(!empty($_SESSION['user_session']) && $admin_action && empty($info)) {
        if (!empty($error))
        {
                        ...
                        <?php  } ?>
                          <footer class="footer">
                            <nav class="navbar navbar-default navbar-bottom" role="navigation">
                              <div class="container">
                                <h1>Powered by <a href="http://github.com/burninbones/piWallet">piWallet</a></h1>
                              </div>
                            </nav>
                          </footer>
